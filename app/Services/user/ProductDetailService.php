...
class ProductDetailService extends Service
{
    ...
    /**
     * this operation use to update the product detail in relative mode
     *
     ...
     */
    public function updateStockRelative($data, $productDetail)
    {   
        ...
        return [$productDetail, $data['quantity']];
    }
     /**
     * this operation use to update the product detail in absolute mode
     *
     * The function update the quantity and the cost of the product detail
     * The expected keys in the data array are:
     * - quantity: the number of the product detail based on the mode
     ...
     * @return \App\Models\ProductDetail the updated product detail
     */
    public function updateStockAbsolute($data, $productDetail) 
    {
        ...
        return [$productDetail, $productDetail->wasChanged() ? $delta : null];
    }
